...
import { Eye, EyeOff, User, Mail, Lock, Sparkles, Calendar, ArrowRight } from 'lucide-react';
            ...
            <div className="relative z-10 w-full max-w-md">
                ...
                <div className="bg-white/10 backdrop-blur-xl rounded-2xl shadow-2xl p-8 border border-white/20 animate-slideUp">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div className="group">
                            ...
                            <div className={`relative transition-all duration-300 ${focusedField === 'name' ? 'transform scale-[1.02]' : ''
                                ...
                                <User className={`absolute left-3 top-1/2 transform -translate-y-1/2 transition-colors duration-300 ${focusedField === 'name' ? 'text-purple-400' : 'text-purple-300'
                                    }`} size={18} />
                                <input
                                    type="text"
                                    ...
                                    required
                                    className="w-full pl-10 pr-4 py-3 bg-white/5 border border-purple-300/30 rounded-lg focus:ring-2 focus:ring-purple-400 focus:border-transparent outline-none text-white placeholder-purple-300/50 transition-all duration-300"
                                />
                            </div>
                        </div>
                        ...
                        <div className="group">
                            ...
                            <div className={`relative transition-all duration-300 ${focusedField === 'email' ? 'transform scale-[1.02]' : ''
                                ...
                                <Mail className={`absolute left-3 top-1/2 transform -translate-y-1/2 transition-colors duration-300 ${focusedField === 'email' ? 'text-purple-400' : 'text-purple-300'
                                    }`} size={18} />
                                <input
                                    type="email"
                        ...
                        <div className="group">
                            ...
                            <div className={`relative transition-all duration-300 ${focusedField === 'password' ? 'transform scale-[1.02]' : ''
                                ...
                                <Lock className={`absolute left-3 top-1/2 transform -translate-y-1/2 transition-colors duration-300 ${focusedField === 'password' ? 'text-purple-400' : 'text-purple-300'
                                    }`} size={18} />
                                <input
                                    ...
                                    required
                                    minLength="6"
                                    className="w-full pl-10 pr-12 py-3 bg-white/5 border border-purple-300/30 rounded-lg focus:ring-2 focus:ring-purple-400 focus:border-transparent outline-none text-white placeholder-purple-300/50 transition-all duration-300"
                                />
                                <button
                                    type="button"
                            ...
                            <p className="text-xs text-purple-300/70 mt-1 ml-1">
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="relative w-full group mt-6 overflow-hidden rounded-lg bg-gradient-to-r from-purple-500 to-pink-500 p-[2px] hover:shadow-lg transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                            <div className="relative flex items-center justify-center space-x-2 bg-gradient-to-r from-purple-500 to-pink-500 rounded-lg px-4 py-3 transition-all duration-300 group-hover:from-purple-600 group-hover:to-pink-600">
                    ...
                    <p className="text-center text-purple-200 mt-6">
                        ...
                        <Link to="/login" className="text-white font-semibold hover:text-purple-200 transition-colors inline-flex items-center space-x-1 group">
                            <span>Login</span>
